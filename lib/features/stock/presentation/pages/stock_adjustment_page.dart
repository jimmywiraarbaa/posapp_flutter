...
class _StockAdjustmentPageState extends ConsumerState<StockAdjustmentPage> {
  ...
  String? _productId;
  StockAdjustmentType _type = StockAdjustmentType.increase;
  ...
  Future<void> _save() async {
    ...
    final products = ref.read(productsStreamProvider(true)).value ?? const [];
            ...
            child: ListView(
              ...
              children: [
                ...
                DropdownButtonFormField<StockAdjustmentType>(
                  ...
                  items: const [
                    DropdownMenuItem(
                      value: StockAdjustmentType.increase,
                      child: Text('Tambah'),
                    ),
                    DropdownMenuItem(
                      value: StockAdjustmentType.decrease,
                      child: Text('Kurang'),
                    ),
                  ],
                  onChanged: (value) {
